...
/*   Updated: 2025/03/13 14:30:01 by kederhet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void load_textures(t_data *data)
{
    ...
    data->north_texture.img = mlx_xpm_file_to_image(data->mlx_connection, 
        "./textures/north.xpm", &data->texture_width, &data->texture_height);
    ...
    data->south_texture.img = mlx_xpm_file_to_image(data->mlx_connection, 
        "./textures/south.xpm", &data->texture_width, &data->texture_height);
    ...
    data->east_texture.img = mlx_xpm_file_to_image(data->mlx_connection, 
        "./textures/east.xpm", &data->texture_width, &data->texture_height);
    ...
    data->west_texture.img = mlx_xpm_file_to_image(data->mlx_connection, 
        "./textures/west.xpm", &data->texture_width, &data->texture_height);
...
int get_texture_color(t_texture *texture, int tex_x, int tex_y)
{
    ...
    pixel = texture->adrr + (tex_y * texture->line_lenght + tex_x * (texture->bits_per_pixel / 8));
